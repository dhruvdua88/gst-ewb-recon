...
export const LogoIcon = (): React.ReactNode => (
...
export const DocumentIcon = ({ className }: { className?: string }): React.ReactNode => (
  <svg className={className || 'h-6 w-6'} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
